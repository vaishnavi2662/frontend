      ...
      {!loading ? (
        <div className="h-screen w-screen bg-slate-200 font-karla">
          ...
          <div className="md:w-32">
            <button  onClick={onPass} className="mt-8 border-2 border-red-500 px-1 py-1 rounded text-white bg-red-500  hover:border-none hover:bg-transparent hover:text-red-500 hover:font-bold">Go To Password</button>
            </div>
          ...
          {click ? (
            <NotesForm click={click} setClick={setClick} Clicked={Clicked} />
          ) : null}
          {loading ? (
            <div>
            ...
            <Notedisplay data={cUser.notes} user={cUser} />
          )}
        </div>
      ) : (
        <div className="flex justify-center place-items-center  mt-64 ">
