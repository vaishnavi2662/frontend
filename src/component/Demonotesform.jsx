...
import { editNotes, editPasswords } from "./Api/Api";
function  Demonotesform({ click, setClick, Clicked, userId, itemKey }) {
    const options = ["Important","Not Important"];
  ...
  const handleSubmit = async () => {
    ...
    const { data } = await axios.put(`${editNotes}/${itemKey}`, values);
    console.log(data);
